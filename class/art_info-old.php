...
function f_category_name($id_catego, $id_lang)
{
  try
  {
   echo $id_catego." et di_lang". $id_lang;
   $bdd = new PDO('mysql:host=localhost;dbname=tarnetgapaypal', 'tarnetgapaypal', 'ELai6GsP');
   //$bdd = new PDO('mysql:host=mysql5-13.xxl;dbname=ma_base', 'utilisateur', 'mot_de_passe');
